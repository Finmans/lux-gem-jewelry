// โ”€โ”€ LUX GEM Mock Data โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
...
// โ”€โ”€ Diamond Stock โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
...
export const collections: Collection[] = [
  {
    ...
    nameTH: "เนเธซเธงเธเธซเธกเธฑเนเธ",
    count: 48,
  ...
  },
  {
    id: "wedding",
    name: "Wedding Bands",
    nameTH: "เนเธซเธงเธเนเธ•เนเธเธเธฒเธ",
    count: 32,
  ...
  },
  {
    id: "high-jewelry",
    name: "High Jewelry",
    nameTH: "เนเธฎเธเธดเธงเน€เธงเธฅเธฃเธตเน",
    count: 12,
...
// โ”€โ”€ Featured Products โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
export const featuredProducts: JewelryProduct[] = [
  ...
  },
  {
    ...
    priceUSD: 8140,
    badge: "New",
    description: "An oval center diamond encircled by a micro-pavรฉ halo, creating a brilliance that seems to multiply endlessly.",
    gradient: "from-[#8A8F98]/20 to-[#C6A878]/5",
  },
  {
    id: "P003",
    name: "รclat Eternity",
    collection: "wedding",
  ...
  },
  {
    ...
    centerStone: "2 ร— 0.8ct Pear F VS1",
    priceTHB: 320000,
    priceUSD: 9140,
    badge: "Limited",
    description: "Pear-shaped diamonds suspended from pavรฉ-set bails โ€” movement, light, and impeccable craft in each pair.",
    gradient: "from-[#D9DDE3]/20 to-[#8A8F98]/10",
  },
];

// โ”€โ”€ The 4Cs Education Data โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
export const fourCs = [
  {
    letter: "C",
    name: "Cut",
  ...
  },
  {
    ...
    name: "Color",
    description:
      "Graded D (colorless) to Z (light yellow). LUX GEM sources primarily Dโ€“F color diamonds โ€” the pinnacle of colorlessness, allowing maximum light transmission.",
    grades: ["D", "E", "F", "G", "H", "I"],
    activeGrade: "D",
  },
  {
...
// โ”€โ”€ Testimonials โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
export const testimonials = [
  {
    ...
    role: "Bride 2024",
    quote:
      "การเลือกแหวนกับ LUX GEM ช่างเป็นประสบการณ์ที่ไม่เหมือนใคร เราได้สร้างแหวนแต่งงานด้วยกันและ 3D preview ตรงกับชิ้นงานจริงอย่างน่าทึ่ง เพชร lab-grown ของเราประกายระยิบระยับจนคู่ของเราต้องกลับมาชื่นชมในความสุขที่ไม่มีวันลืม",
    rating: 5,
  ...
  {
    name: "ธนกฤต ประดิษฐวัฒน์",
    nameEN: "Thanakorn P.",
    role: "Gift Purchase",
    quote:
      "ฉันต้องการทำแหวนพรีเมียมสำหรับวันครบรอบของเรา และฝีมือการผลิตนั้นน่าทึ่งมาก LUX GEM ทำให้ฉันมั่นใจในคุณภาพและความประณีตของงาน เราได้รับ IGI cert พร้อมเพชรทุกเม็ดและงานออกมาตรงตามแบบที่เราต้องการทุกประการ",
    rating: 5,
...
// โ”€โ”€ Certifications & Trust โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€โ”€
