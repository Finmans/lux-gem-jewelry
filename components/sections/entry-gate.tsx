...
const CONTENT = {
  en: {
    headerLabel: "How would you like to begin?",
    headerTitle: "Your journey starts here",
    paths: [
      {
        label: "01",
        title: "Shop Collections",
        titleTH: "เลือกจากคอลเลกชัน",
        description: "Browse our curated jewelry collections — from solitaire engagement rings to high jewelry masterworks. Find the design that speaks to you.",
      ...
      },
      {
        ...
        description: "Browse our certified lab diamonds by shape, carat, color, clarity, and cut. Select your perfect stone and build around it.",
        cta: "Search Diamonds",
        href: "/diamonds",
        accent: "#D9DDE3",
      ...
      },
      {
        ...
        description: "Choose your diamond. Choose your setting. See your ring in a 3D real-time preview before it's crafted by hand just for you.",
        cta: "Start Building",
        href: "/build",
        accent: "#8A8F98",
  ...
  th: {
    headerLabel: "คุณอยากเริ่มต้นอย่างไร?",
    headerTitle: "เส้นทางของคุณเริ่มที่นี่",
    paths: [
      {
        label: "01",
        title: "ช้อปคอลเลกชัน",
        titleTH: "เลือกจากคอลเลกชัน",
        description: "ชมคอลเลกชันเครื่องประดับที่คัดสรรแล้ว — ตั้งแต่แหวนหมั้นแบบ Solitaire ไปจนถึงงาน High Jewelry พิเศษ ค้นหาดีไซน์ที่คุณชอบ",
        cta: "สำรวจคอลเลกชัน",
        href: "/collections",
        accent: "#C6A878",
        gradient: "from-[#C6A878]/12 via-[#C6A878]/4 to-transparent",
      ...
      {
        label: "02",
        title: "ค้นหาเพชรคงคลัง",
        titleTH: "เลือกเพชรจากสต็อก",
        description: "ชมเพชร Lab-Grown ที่ได้รับการรับรองตามรูปทรง กะรัต สี ความใส และการเจียระไน เลือกเพชรที่เหมาะกับคุณแล้วสร้างแหวนรอบๆ",
        cta: "ค้นหาเพชร",
        href: "/diamonds",
        accent: "#D9DDE3",
        gradient: "from-[#D9DDE3]/10 via-[#D9DDE3]/3 to-transparent",
      ...
      {
        label: "03",
        title: "ออกแบบแหวนของคุณ",
        titleTH: "ประกอบแหวนด้วยตัวเอง",
        description: "เลือกเพชร เลือกเซ็ตติ้ง ดูแหวนของคุณแบบ 3D เรียลไทม์ก่อนที่มันจะถูกสร้างขึ้นมาสำหรับคุณเท่านั้น",
        cta: "เริ่มออกแบบ",
        href: "/build",
        accent: "#8A8F98",
        gradient: "from-[#8A8F98]/10 via-[#8A8F98]/3 to-transparent",
            ...
            >
              ...
              >
                <motion.div
                  ...
                  style={{ background: `radial-gradient(ellipse at 50% 0%, ${path.accent}15 0%, transparent 65%)` }}
                />
                <div
                  className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                  style={{ backgroundImage: `radial-gradient(circle at 70% 20%, ${path.bgPattern} 0%, transparent 60%)` }}
                />
