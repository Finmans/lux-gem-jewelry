...
const CONTENT = {
  en: {
    ...
    headline: ["Fine jewelry for", "every chapter"],
    headlineEm: "every chapter",
    viewAll: "View All Collections",
    from: "From",
    pieces: "pieces",
  },
  th: {
    sectionLabel: "คอลเลกชัน",
    headline: ["เครื่องประดับล้ำค่า", "สำหรับทุกก้าวสำคัญ"],
    headlineEm: "สำหรับทุกก้าวสำคัญ",
            ...
            <motion.div key={col.id} variants={item}>
              ...
              >
                ...
                <div className={`relative flex items-center justify-center bg-gradient-to-br ${col.gradient} h-56 overflow-hidden`}>
                  ...
                  <GemSparkle size={18} delay={0} duration={1.5} repeatDelay={2} color="#F6F1E8" className="top-4 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <GemSparkle size={10} delay={0.8} duration={1.2} repeatDelay={2.5} color="#C6A878" className="bottom-5 left-8 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                ...
                <div className="p-6 bg-[#0D0D10] relative overflow-hidden">
                  ...
                  <div className="relative">
                    <h3 className="font-display text-xl font-light text-[#F6F1E8] group-hover:text-[#C6A878] transition-colors duration-300">
                      {locale === "th" && col.nameTH ? col.nameTH : col.name}
                    </h3>
                    <p className="text-[9px] tracking-[0.2em] text-[#8A8F98] mt-0.5 mb-3 uppercase">
                      {locale === "th" ? col.name : col.nameTH}
                    </p>
                    ...
                    <div className="flex items-center justify-between mt-5 pt-4 border-t border-[#1A1A1E] group-hover:border-[#C6A878]/15 transition-colors duration-500">
                      <div>
                        <p className="text-[9px] text-[#8A8F98]/60 tracking-wider uppercase">{c.from}</p>
