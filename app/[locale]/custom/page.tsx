...
export default async function CustomDesignPage({ params, searchParams }: Props) {
  ...
  return (
    <main className="min-h-screen bg-[#0B0B0D] pt-20">
      <section className="border-b border-[#1A1A1E] py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-display text-5xl sm:text-6xl font-light text-[#F6F1E8] mb-4">
            {sp.intent === "source" ? "Diamond Sourcing Request" : "Custom Design"}
          </h1>
      ...
      <section className="py-14">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <CustomInquiryForm intent={sp.intent} product={sp.product} />
        </div>
      </section>
    </main>
  );
